    ...
    def start(self):
        try:
            ...
            listener_config = {
                ...
                'flask_secret_key': self.config.get('web.secret_key', 'neoc2-http-listener-secret-key-change-in-production')
            }
...
app = Flask(__name__)
app.config['SECRET_KEY'] = config.get('flask_secret_key', 'neoc2-http-listener-secret-key-change-in-production')
